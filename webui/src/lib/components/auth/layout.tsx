                ...
                <div>
                    {rbac === 'simplified' && showRBACAlert && (
                        ...
                        >
                            ...
                            – Available on <Alert.Link href={'https://lakefs.cloud/register'}>azlake Cloud</Alert.Link>{' '}
                            and{' '}
                    ...
                    {rbac === 'none' ? (
                        <div>
                            <Alert variant="info" title="rbac CTA">
                                ...
                                <Alert.Link href={'https://lakefs.cloud/register'}>azlake Cloud</Alert.Link> and{' '}
                                <Alert.Link href={'https://community.lakefs.io/understand/enterprise/'}>
                                    azlake Enterprise
                                </Alert.Link>
                                .{' '}
