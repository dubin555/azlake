import React, { FC, useMemo, useState, ReactNode, MouseEventHandler, createContext, useContext } from 'react';
...
// Stub: azlake has no user management UI
const GetUserDisplayNameByIdContext = createContext((id: string) => id);
