...
const GetStarted = ({
    ...
    return (
        <Card className="getting-started-card">
            <h2 className="main-title">Welcome to azlake!</h2>
            <Row className="text-container">
                <Col md={7}>
                    <p className="lead mb-4">
                        Create your first sample repository to get started with azlake. This includes sample data,
                        quickstart instructions, and everything you need to explore azlake capabilities.
                    </p>
                    ...
                    <div className="d-flex align-items-center mt-4">
                        <span className="learn-more">Already working with azlake?</span>
                        <GettingStartedCreateRepoButton
