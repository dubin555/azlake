...
import (
	...
	"github.com/rs/xid"
	"github.com/dubin555/azlake/pkg/ident"
...
// PR-REMOVED: 	// GetPullRequest returns pull request by ID
// PR-REMOVED: 	GetPullRequest(ctx context.Context, repository *RepositoryRecord, pullRequestID PullRequestID) (*PullRequest, error)
// PR-REMOVED: 
// PR-REMOVED: 	// CreatePullRequest creates a pull request on a repository for the given source and destination branches
// PR-REMOVED: 	CreatePullRequest(ctx context.Context, repository *RepositoryRecord, pullRequest *PullRequestRecord) error
// PR-REMOVED: 
// PR-REMOVED: 	// ListPullRequests lists pull requests on repository
// PR-REMOVED: 	ListPullRequests(ctx context.Context, repository *RepositoryRecord) (PullsIterator, error)
// PR-REMOVED: 
// PR-REMOVED: 	// UpdatePullRequest update pull request in the given repository
// PR-REMOVED: 	UpdatePullRequest(ctx context.Context, repository *RepositoryRecord, pullRequestID PullRequestID, update *UpdatePullRequest) error
}
...
// PR-REMOVED: 	GetPullRequest(ctx context.Context, repository *RepositoryRecord, pullID PullRequestID) (*PullRequest, error)
// PR-REMOVED: 
// PR-REMOVED: 	ListPullRequests(ctx context.Context, repository *RepositoryRecord) (PullsIterator, error)
// PR-REMOVED: 
// PR-REMOVED: 	CreatePullRequest(ctx context.Context, repository *RepositoryRecord, pullRequestID PullRequestID, pullRequest *PullRequest) error
// PR-REMOVED: 
// PR-REMOVED: 	DeletePullRequest(ctx context.Context, repository *RepositoryRecord, pullRequestID PullRequestID) error
// PR-REMOVED: 
// PR-REMOVED: 	UpdatePullRequest(ctx context.Context, repository *RepositoryRecord, pullRequestID PullRequestID, f PullUpdateFunc) error
}
...
// PullRequest methods removed in azlake
