...
import (
	...
	"github.com/dubin555/azlake/pkg/batch"
	"github.com/dubin555/azlake/pkg/block"
	blockfactory "github.com/dubin555/azlake/pkg/block/factory"
	"github.com/dubin555/azlake/pkg/config"
	"github.com/dubin555/azlake/pkg/graveler"
	"github.com/dubin555/azlake/pkg/graveler/branch"
	"github.com/dubin555/azlake/pkg/graveler/committed"
	"github.com/dubin555/azlake/pkg/graveler/ref"
	"github.com/dubin555/azlake/pkg/graveler/retention"
	"github.com/dubin555/azlake/pkg/graveler/settings"
	"github.com/dubin555/azlake/pkg/graveler/sstable"
	"github.com/dubin555/azlake/pkg/graveler/staging"
	...
	"github.com/dubin555/azlake/pkg/pyramid"
	pyramidparams "github.com/dubin555/azlake/pkg/pyramid/params"
	"github.com/dubin555/azlake/pkg/upload"
...
func New(ctx context.Context, cfg Config) (*Catalog, error) {
	...
	adapter, err := blockfactory.BuildBlockAdapter(ctx, nil, cfg.Config.StorageConfig().GetStorageByID(config.SingleBlockstoreID))
	if err != nil {
		cancelFn()
